...
angular.
	module('nifiApp').controller('dodajInputCtrl', function($scope, $http)
{
	...
	$http.post("http://localhost:9090/nifi-api" + grupa +"/input-ports", dane)
	...
	location.reload();
		...
		{
			alert("input port nie zostal utworzony");
		}
		}
